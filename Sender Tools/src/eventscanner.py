...
if __name__ == "__main__":
    ...
    RCC_ADDRESS = "0x8BD5b5E98cA42797b5Ad92D315b0006952198e10"
        ...
        def process_event(self, block_when: datetime.datetime, event: AttributeDict) -> str:
            ...
            if event["event"] == "newOrder":
                event_dict = {
                    ...
                    "_gasForDelivery": args["_gasForDelivery"],
                    "_gasPrice": args["_gasPrice"],
                    "_location": args["_location"],
                    "_orderDate": args["_orderDate"]
                }
            elif event["event"] == "GasPriceChanged":
                event_dict = {
                    "orderID": args["OrderID"],
                    "_newGasPrice": args["_newGasPrice"]
                }
            else:
                event_dict = {}
            ...
            self.state["blocks"][block_number][txhash][log_index] = event_dict
    ...
    def run():
        ...
        if len(sys.argv) < 2:
            ...
            sys.exit(1)
        """
        api_url = 'https://polygon-mumbai.g.alchemy.com/v2/f1Y39CJVpQcN_WXeiJBtF-73_EnkTOqY'
        ...
        scanner = EventScanner(
            ...
            contract=ERC20,
            state=state,
            events=[ERC20.events.newOrder,
                    ERC20.events.GasPriceChanged,
                    ERC20.events.dataDelivered
                    ],
